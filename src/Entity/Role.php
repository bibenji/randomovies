 ...
 *
 * @ORM\Table(name="role")
 * @ORM\Entity(repositoryClass="Randomovies\Repository\RoleRepository")
 */
class Role
{
     ...
     * @var Movie
     *
     * @ORM\ManyToOne(targetEntity="Randomovies\Entity\Movie", inversedBy="roles")
     ...
     * @var Person
     *
     * @ORM\ManyToOne(targetEntity="Randomovies\Entity\Person", inversedBy="roles", cascade={"persist"})
